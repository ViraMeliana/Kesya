...
{{--                    </thead>--}}
{{--                    <tbody>--}}
{{--                    @foreach($tabunganMudharabahs as $key => $tabunganMudharabah)--}}
...
{{--                            </td>--}}
{{--                            <td>--}}
{{--                                @can('tabungan_mudharabah_show')--}}
{{--                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.tabungan-mudharabahs.show', $tabunganMudharabah->id) }}">--}}
{{--                                        {{ trans('global.view') }}--}}
{{--                                    </a>--}}
{{--                                @endcan--}}

{{--                                @can('tabungan_mudharabah_edit')--}}
{{--                                    <a class="btn btn-xs btn-info" href="{{ route('admin.tabungan-mudharabahs.edit', $tabunganMudharabah->id) }}">--}}
{{--                                        {{ trans('global.edit') }}--}}
{{--                                    </a>--}}
{{--                                @endcan--}}

{{--                                @can('tabungan_mudharabah_delete')--}}
{{--                                    <form action="{{ route('admin.tabungan-mudharabahs.destroy', $tabunganMudharabah->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">--}}
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.tabungan-mudharabahs.massDestroy') }}",
